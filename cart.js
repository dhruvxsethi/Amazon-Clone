function getCartItems() {
    db.collection("cart-items").onSnapshot((snapshot) =>{
        ...
        snapshot.docs.forEach((doc) => {
            cartItems.push ({
                id:doc.id,
                //spread operator, which takes all the data in the current collection, instead of writing all the key value pairs again & again
                //like a present, which u unpack, and then take all the items out of it
                ...doc.data()
            })
        })
